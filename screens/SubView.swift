...
class SubView: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.navigationController!.navigationBar.frame = CGRect(x: 0, y: 0, width: self.view.frame.size.width, height: 80.0)
         self.navigationController?.navigationBar.barTintColor = UIColor(colorLiteralRed: 0/255.0, green: 150/255.0, blue: 177/255.0, alpha: 1)
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        //navigationItem.leftBarButtonItem = UIBarButtonItem(customView: irctc)
